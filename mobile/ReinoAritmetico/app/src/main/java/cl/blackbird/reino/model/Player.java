...
public class Player implements Serializable {
   ...
   // public String pjID;
    ...
    public Player(String name/*,String pjID*/, School school, ClassRoom classRoom) {
        this.androidID = null;
        this.name = name;
       // this.pjID=pjID;
        this.school = school;
    ...
    public Player(String name/*,String pjID*/, School school, ClassRoom classRoom, String androidID) {
    ...
    public static Player fromJSON(JSONObject json) throws JSONException {
        ...
        return new Player(json.getString("name")/*,json.getString("pjid")*/, tempSchool, tempClassRoom);
    }
}
